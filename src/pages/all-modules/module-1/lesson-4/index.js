      ...
      <>
        <div className="flex justify-end mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            Ценные бумаги — это документы, которые подтверждают, что ты{" "}
            <span className="bg-[#D8E2DE]">дал на время деньги</span> какой-то
            компании.
          </p>
        ...
        <p className="text-[16px] mb-[30px]">
          ...
          свои деньги, и еще{" "}
          <span className="bg-[#D8E2DE]">проценты сверху.</span> В следующих
          уроках подробнее разберем, как работают разные ценные бумаги.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-end mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            Инвестиции — <span className="bg-[#D8E2DE]">это не волшебство</span>
            , не быстрый способ разбогатеть за неделю, а инструмент.
          </p>
        ...
        <p className="text-[16px] mb-[30px]">
          ...
          Инвестиции <span className="bg-[#D8E2DE]">работают так же:</span> они
          помогают сохранить и увеличить накопления.
        </p>
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          ...
          принести доход без пополнений. Это называется{" "}
          <span className="bg-[#D8E2DE]">инвестиционная идея.</span>
        </p>
      </>
    ),
    bg: "bg-white text-black",
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-end mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            <span className="font-semibold">Например</span>, ты замечаешь, что
            многие ездят на электросамокатах. Если тренд продолжится, компания,
            которая их делает, может заработать больше.
          </p>
        ...
        <p className="text-[16px] mb-[30px]">
          ...
          потенциально заработать.{" "}
          <span className="bg-[#D8E2DE]">Это и есть инвестиционная идея.</span>
        </p>
      </>
    ),
    bg: "bg-white text-black",
      ...
      <>
        <div className="flex justify-end mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            ...
            <span className="font-semibold">сложного процента</span>: когда ты
            получаешь доход{" "}
            <span className="bg-[#D8E2DE]">не только с вложенной суммы,</span>{" "}
            но и с уже накопленных процентов.
          </p>
      ...
      <>
        <div className="flex justify-end mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            ...
            <span className="font-semibold">усиливается со временем.</span> Это
            называется «деньги делают деньги». И чем больше срок — тем сильнее
            этот эффект.
          </p>
        ...
        <p className="text-[16px] mb-[30px]">
          <span className="font-semibold">Например</span>, 1 млн ₽ через 5 лет в
          инвестициях может{" "}
          <span className="bg-[#D8E2DE]">превратиться в 1,7 млн ₽,</span> даже
          если не пополнять свои вложения. Так работает сложный процент.
        </p>
      </>
    ),
    bg: "bg-white text-black",
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px] text-[20px]">
      ...
      <>
        <div className="flex justify-end mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            ...
            достичь цели немного раньше{" "}
            <span className="bg-[#D8E2DE]">или накопить больше,</span> чем
            планируешь.
          </p>
