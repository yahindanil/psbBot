...
export default function Lesson() {
  ...
  const [inflationInput, setInflationInput] = useState("1");

  // Функция расчета инфляции (7.04% в год)
  const calculateInflation = (value) => {
    if (!value || value.trim() === "") {
      return "1.07";
    }
    const numValue = parseFloat(value) || 0;
    return (numValue * 1.0704).toFixed(2);
  };
        ...
        <>
          <div className="flex justify-end mb-[15px]">
            <p className="text-[16px] mb-[30px]">
              Представь: ты копишь на велосипед. Наконец нужная сумма в копилке,
              а цена выросла. Пришлось на два месяца отложить покупку, чтобы
              собрать денег. А так хотелось летом гонять на новом велике!
            </p>
    ...
    },
    {
      ...
      content: (
        <>
          <div className="flex justify-end mb-[15px]">
            <p className="text-[16px] mb-[30px]">
              Инфляция — <span className="bg-[#D8E2DE]">не баг системы</span>, а
              фича. Если бы инфляции совсем не было, экономика не смогла бы
              развиваться. Не было бы так много товаров и услуг, которые можно
              купить.
            </p>
          ...
          <p className="text-[16px] mb-[30px]">
            Но, если просто хранить деньги в копилке или на карте, они{" "}
            <span className="bg-[#D8E2DE]">теряют ценность.</span> Инфляция со
            временем сведет накопления. Согласен, неприятно, но это так.
          </p>
          <div className="flex justify-center mt-[20px]">
            <Image
      ...
      content: (
        <>
          ...
          <div className="flex items-center justify-center mb-[30px]">
            <div className="bg-white border border-gray-300 rounded-[8px] px-[16px] py-[12px] flex items-center justify-between w-[145px]">
              <input
                type="text"
                placeholder="1"
                ...
                maxLength={9}
                className="text-[16px] font-semibold text-gray-900 bg-transparent border-none outline-none w-[80px]"
              />
            ...
            <div className="bg-white border border-gray-300 rounded-[8px] px-[16px] py-[12px] flex items-center justify-between w-[145px]">
              <span className="text-[16px] font-semibold text-gray-900">
                {calculateInflation(inflationInput)}
              </span>
              <span className="text-[16px] font-semibold text-gray-900">₽</span>
            </div>
          </div>
      ...
      content: (
        <>
          ...
          <p className="text-[16px] mb-[30px]">
            ...
            Но, если собираешься копить год или больше, на всякий случай
            добавляй к сумме запас —{" "}
            <span className="bg-[#D8E2DE]">хотя бы 10%.</span>
          </p>
          <div className="flex justify-center mt-[20px]">
            <Image
    ...
    },
    {
      ...
      content: (
        <>
          <div className="flex justify-end mb-[15px]">
            <p className="text-[16px] mb-[30px]">
              Если не подстроиться под рост цен, в нужный момент может не
              хватить денег на покупку.{" "}
              <span className="bg-[#D8E2DE]">Но есть секретный прием</span>,
              который поможет увеличить твои накопления. О нем поговорим в
              следующем уроке.
            </p>
