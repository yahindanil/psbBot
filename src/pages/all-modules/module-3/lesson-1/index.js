    ...
    content: (
      <>
        <h1 className="text-center text-[24px] font-semibold mb-[24px]">
          Что такое акции <br />и как они работают
        </h1>
    ...
    content: (
      <>
        ...
        <p className="text-[16px] text-white mb-[30px]">
          Акция — это доля в компании. Когда ты покупаешь акцию, у тебя
          появляется «кусочек» компании.
        </p>
        <p className="text-[16px] text-white mb-[30px]">
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          Представь: бизнес хочет развиваться, выпускать новые продукты. Для
          этого нужны средства, но свободный денег у компании пока нет.
        </p>
        <p className="text-[16px]">
          Поэтому компания предлагает инвесторам поучаствовать в своем развитии
          через акции. Получает деньги на свои проекты, а инвестор — шанс
          заработать, если все сложится хорошо.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px]">
            Наоборот тоже бывает: если план компании не сработает, инвесторы
            потеряют деньги. В инвестициях риск есть всегда.
          </p>
      ...
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px]">
            ...
            частью своей прибыли с акционерами — теми, кто владеет их акциями.
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          Цена акций зависит от того, каким инвесторы видят будущее компании.
        </p>
        <p className="text-[16px] mb-[30px]">
        ...
        <p className="text-[16px]">
          ...
          ее акции, их цена будет расти. А когда инвесторы, наоборот, хотят
          продать акции компании, то их цена будет падать.
        </p>
      </>
    ),
    bg: "bg-white text-black",
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px]">
            Вот как цена акций может реагировать на поведение инвесторов:
          </p>
          <div className="text-[10px] text-[#D8E2DE]">7/10</div>
        </div>
        <ul className="text-[16px] space-y-[15px] mb-[30px]">
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          Цена акций может меняться каждый день. Они могут подорожать — и ты
          заработаешь. Но если что-то пойдет не так, акции подешевеют, и ты
          можешь потерять часть денег.
        </p>
        <p className="text-[16px]">
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px]">
            Акции — это инструмент на долгий срок, он не подойдет для
            краткосрочных целей. Здесь не стоит рассчитывать на результат через
            неделю и даже через год. Зато их можно использовать на будущее.
            Например, собрать деньги на старт своего бизнеса.
          </p>
    ...
    content: (
      <>
        ...
        <p className="text-[16px] text-white mb-[30px]">
          ...
          которая поможет стать владельцем долей компании. Инвестор зарабатывает
          на акциях, если компания растет и платит дивиденды.
        </p>
        <p className="text-[16px] text-white">
