    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[53px]">
          С ПИФами так же: не нужно выбирать одну акцию — можно вложиться сразу
          в несколько компаний через один фонд.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          ПИФ — это коллективные инвестиции. Управляющая компания распределяет
          деньги инвесторов между активами — например, акциями крупных компаний.
        </p>
        <p className="text-[16px]">
          Инвестор покупает пай — кусочки нескольких активов, а не одну дорогую
          акцию в одиночку. Это как скинуться с друзьями на подписку на
          онлайн-кинотеатр вместо того, чтобы каждому платить всю сумму.
        </p>
      </>
    ),
      ...
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px] mb-[18px]">
            ПИФ может состоять из одинаковых или разных инструментов. Все
            зависит от того, какую стратегию выбрала управляющая компания.
          </p>
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            Состав ПИФов прозрачен, как и работа фонда. Ты всегда можешь
            посмотреть, во что профессионалы вложили деньги фонда, какую
            доходность он приносил в прошлом, кто им управляет. Управляющую
            компанию регулирует Центральный банк РФ.
          </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          Подходят для старта в инвестициях. Тебе не нужно копить десятки тысяч
          рублей, чтобы купить ценные бумаги крупных компаний. Начать
          инвестировать в фонды можно со 100 рублей. Это безопаснее, чем сразу
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            Помогают снижать риски. Некоторые ПИФы позволяют купить долю в
            готовом портфеле из разных инструментов: акций, облигаций,
            драгоценных металлов, валюты.
          </p>
          <div className="text-[10px] text-[#D8E2DE]">6/7</div>
        </div>
        <p className="text-[16px]">
          Это помогает снижать риски: если что-то одно упадет в цене, другой
          актив может вырасти.
        </p>
      </>
    ),
