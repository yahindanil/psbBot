...
const lessonPages = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          Чтобы покупать активы,{" "}
          <span className="font-semibold">нужен специальный счет.</span> Его
          открывают у брокера — посредника между тобой и рынком ценных бумаг.
        </p>
      </>
    ),
      ...
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          <span className="font-semibold">
            Брокерский счет — это твой личный кабинет на фондовом рынке.
          </span>{" "}
          На нем можно хранить деньги, покупать и продавать ценные бумаги.
        </p>
        <p className="text-[16px] mb-[30px]">
          Без брокерского счета купить или продать ценные бумаги нельзя.{" "}
          <span className="bg-[#D8E2DE]">Это как аккаунт в онлайн-игре:</span>{" "}
          без него ты не попадешь на сервер и не сможешь играть.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <h2>Где открывают брокерские счета и кто может это сделать</h2>
      ...
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            ...
            или в офисе брокера. Это можно{" "}
            <span className="bg-[#D8E2DE]">сделать только с 18 лет.</span> Но
            уже сейчас ты можешь разобраться, как все устроено, и даже накопить
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[18px]">
          ...
          <span className="font-semibold">
            Для новичков доступны самые базовые инструменты:
          </span>{" "}
          акции, облигации, валюта, паи ПИФов. То, с чем несложно разобраться с
          нуля самостоятельно.
        </p>
      </>
    ),
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[18px]">
          ...
          прошло,{" "}
          <span className="bg-[#D8E2DE]">
            то у тебя в портфеле новые активы.
          </span>
        </p>
        <div className="flex justify-center">
          <Image
    ...
    content: (
      <>
        ...
        <p className="text-[16px]">
          ...
          вещь, а{" "}
          <span className="bg-[#D8E2DE]">инвестиционный инструмент,</span>{" "}
          который потенциально может принести доход.
        </p>
      </>
    ),
    bg: "bg-white text-black",
