  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[30px]">
          <span className="font-semibold">Приготовить самостоятельно:</span>{" "}
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[18px]">
          ...
          поручить это специалистам. Это называется{" "}
          <span className="bg-[#D8E2DE]">доверительным управлением.</span>
        </p>
        <p className="text-[16px] mb-[18px]">
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            <span className="font-semibold">
              Управляющие подбирают вложения под конкретного человека
            </span>
            : учитывают его цель, сумму и отношение к риску. Это как заказать
            кроссовки по индивидуальному дизайну, а не купить готовые, как у
            всех.
          </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-[16px] mb-[18px]">
          Инвесторы покупают не бумаги отдельно,{" "}
          <span className="bg-[#D8E2DE]">а доли в этой коробке.</span> Такая
    ...
    content: (
      <>
        ...
        <p className="text-[16px]">
          ...
          компании, читают новости.{" "}
          <span className="bg-[#D8E2DE]">Задача инвестора</span> — выбрать
          подходящий фонд.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <div className="flex justify-between items-start mb-[15px]">
          <p className="text-[16px] mb-[30px]">
            Если ты только начинаешь разбираться в инвестициях,{" "}
            <span className="font-semibold">
              ПИФ может быть отличным стартом.
            </span>{" "}
            Тебе не нужно самостоятельно выбирать отдельные акции или облигации
            и разбираться в финансовых показателях компаний.
          </p>
    ...
    content: (
      <>
        ...
        <p className="text-center text-white text-[16px]">
          <span className="bg-[#DFB57F]">ПИФы — это готовый набор</span> из
          разных активов. В структуре уже все рассказу, из чего они состоят.
        </p>
      </>
    ),
    bg: "bg-[#749484]",
